  ...
  run() {
    return [
      ...
      },
      {
        ...
        color: 'rosa',
        size: 'G',
        media: 'https://images.unsplash.com/photo-1607082349566-187342175e2f?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8Y291cG9ufGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60'
      },
    ];
  }
}